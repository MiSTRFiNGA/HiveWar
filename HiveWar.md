...
| | |
|---|---|
| **Version** | `0.3.10` · `sw.js` `CACHE_VERSION = v31` |
...
| **APK (one only)** | `C:\Users\MiSTRFiNGA\Desktop\My Games\_APKs\HiveWar-0.3.10.apk`. Older War APKs are in `_APKs\Archive`. |
...
### 2026-08-22 — Grok · v0.3.10 · crawler was two animals

Played locally: lane-edge Crawler used a skeletal quadruped while south was a skull hopper. SE/SW now copy the hopper walk. Colossus lanes already tank from 0.3.9.
